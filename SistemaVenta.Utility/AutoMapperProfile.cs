    ...
    public class AutoMapperProfile:Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<UsuarioDTO, Usuario>()
                ...
                .ForMember(destino => destino.EsActivo, opt => opt.MapFrom(origen => 
            ...
            CreateMap<Venta, VentaDTO>()
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.TotalVenta.Value, new CultureInfo("es-Pe")))
                )
            ...
            CreateMap<DetalleVenta, ReporteDTO>()
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.TotalVenta.Value, new CultureInfo("es-Pe")))
                )

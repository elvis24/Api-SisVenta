...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C44EBE393");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F961F7234");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4834C06AA16");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A499DDFEF7");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A26CD02B7");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132215B248B");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76B6148EC6");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6C1F138F8");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56148F492DF7");
